 ...
 * 
 * Helper functions to automatically create journal entries from business transactions.
 * Called by transaction mutations (sales, purchases, expenses, payments, etc.)
 */

import { Id } from "./_generated/dataModel";

// Generate Journal Entry Number
export async function generateJournalNumber(ctx: any): Promise<string> {
  const now = new Date();
