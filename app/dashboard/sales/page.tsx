  ...
  const addToCart = (product: any, variant?: any) => {
    setCart(prev => {
      ...
      return [...prev, {
        ...
        maxStock: 100, // TODO: Fetch real stock from productStock table
      }];
    });
      ...
      <div className="w-full md:w-[400px] lg:w-[450px] bg-white flex flex-col h-full shadow-xl z-10">
        ...
        <div className="p-4 bg-white border-t border-slate-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button variant="outline" className="w-full border-slate-300" onClick={() => setCart([])}>
              Batal
            </Button>
